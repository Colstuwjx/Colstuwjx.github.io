...
这里可以看下 Git 当初的[第一个 commit](https://github.com/git/git/tree/e83c5163316f89bfbde7d9ab23ca2e25604af290)，相对来说还是比较简单清晰的。这个一长串的字符就是 Git 每次提交的一个唯一标识，它其实是一个哈希值，我们后面会介绍到它是如何产生的。
